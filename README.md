...
## NOTE
 **The script uses a dummy password(sAMp1ep@ssw0rD:_T35t) for demonstration. Never use this password in a production environment and DO NOT use this script to hash real passwords!**
