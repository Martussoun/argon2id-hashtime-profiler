...
3. **Activate the virtual environment**
   ...
   ```
4.  **Install Python dependencies.** Run the following command in the terminal:
    ```bash
...
## NOTE:
 **The script uses a dummy password(sAMp1ep@ssw0rD:_T35t) for demonstration. Never use this password in a production environment and DO NOT use this script to hash real passwords(changing the dummy password in the script) as they are displayed on benchmark/tuning completion!**
